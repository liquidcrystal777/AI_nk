...
const ANALYZER_SYSTEM_PROMPT = [
  ...
  '  "originalSentence": "正文中包含目标词的唯一一条最关键原句；若找不到则返回空字符串",',
  '  "usageExplanation": "记忆/词根拆解，只写 1 句，优先词根、构词、联想，短、准、好记",',
  '  "sentiment": "只能是 [正+]、[负-]、[中性] 三者之一",',
  '  "deodorizedMeaning": "去味解释：去掉翻译腔、词典腔、硬译腔，用中国人自然会说的话解释它常见是什么意思，只写 1 句"',
  "}",
  ...
  "5. originalSentence：只返回一条原句，必须逐字来自提供正文。",
  "6. usageExplanation：不是普通释义，只保留一条最有记忆点的词根/构词/联想提示。",
  "7. sentiment：只能输出 [正+]、[负-]、[中性]。",
  "8. deodorizedMeaning：不要翻译腔，不要“表示某种含义”“引申为”这种空话，要像中文母语者平时会说的话。",
...
export function buildWordGenerationPrompt(params: {
  ...
  return [
    ...
    "7. deodorizedMeaning 请按“去味”写：剔除翻译腔，用中国人一看就懂的话解释这个词常见是什么意思。",
    "8. originalSentence 只保留一条最关键原句。",
