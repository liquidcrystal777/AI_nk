...
export function normalizeBackupWord(word: WordRecord): Omit<WordRecord, "id"> {
  ...
  return {
    ...
    confusingMeaning1: normalizeSingleLineText(word.confusingMeaning1),
    confusingMeaning2: normalizeSingleLineText(word.confusingMeaning2),
    confusingMeaning3: normalizeSingleLineText(word.confusingMeaning3),
